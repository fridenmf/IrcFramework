...
import com.friden.ircframework.serverCommunication.IrcServerReader;
import com.friden.ircframework.serverCommunication.IrcServerWriter;
...
public abstract class IrcBot {
	...
	public void connect(String host, int port, String nick, String user, String description) {
		...
		try {
			...
			serverWriter = new IrcServerWriter(socket);
			serverWriter.start();
